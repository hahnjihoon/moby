class Rlwjrnl {
  ...
  factory Rlwjrnl.fromMap(Map<String, dynamic> map) {
    return Rlwjrnl(
      id: map['id'] ?? 0,
  ...
  @override
  String toString() {
    return 'Rlwjrnl{id: $id, majorClass: $majorClass, middleClass: $middleClass, minorClass: $minorClass, imageUrl: $imageUrl, pageUrl: $pageUrl, productName: $productName, brand: $brand, salesCom: $salesCom, price: $price, madeIn: $madeIn, weight: $weight, size: $size, color: $color}';
  }
}
