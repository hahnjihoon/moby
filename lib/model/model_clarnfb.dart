class Clarnfb {
  ...
  factory Clarnfb.fromMap(Map<String, dynamic> map) {
    return Clarnfb(
      id: map['id'] ?? 0,
  ...
  @override
  String toString() {
    return 'Clarnfb{id: $id, majorClass: $majorClass, middleClass: $middleClass, minorClass: $minorClass, imageUrl: $imageUrl, pageUrl: $pageUrl, productName: $productName, brand: $brand, salesCom: $salesCom, price: $price, madeIn: $madeIn, weight: $weight, size: $size, color: $color}';
  }
}
