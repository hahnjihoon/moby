...
class SelectRlwjrnlScreen extends StatefulWidget {
  final List<Rlwjrnl> data;

  SelectRlwjrnlScreen({Key? key, required this.data}) : super(key: key);

  @override
  _SelectRlwjrnlScreenState createState() => _SelectRlwjrnlScreenState();
}

class _SelectRlwjrnlScreenState extends State<SelectRlwjrnlScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text('moby_rlwjrnl_compare'),
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    filteredData.length,
                        (index) {
                          Rlwjrnl product = filteredData[index];
                      return SizedBox(
                        width: 200, // 고정된 너비
                        child: Card(
