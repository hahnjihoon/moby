...
class SelectWjwqudScreen extends StatefulWidget {
  final List<Wjwqud> data;

  SelectWjwqudScreen({Key? key, required this.data}) : super(key: key);

  @override
  _SelectWjwqudScreenState createState() => _SelectWjwqudScreenState();
}

class _SelectWjwqudScreenState extends State<SelectWjwqudScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    filteredData.length,
                        (index) {
                          Wjwqud product = filteredData[index];
                      return SizedBox(
                        width: 200, // 고정된 너비
                        child: Card(
