...
class SelectDldbtlrScreen extends StatefulWidget {
  final List<Dldbtlr> data;

  SelectDldbtlrScreen({Key? key, required this.data}) : super(key: key);

  @override
  _SelectDldbtlrScreenState createState() => _SelectDldbtlrScreenState();
}

class _SelectDldbtlrScreenState extends State<SelectDldbtlrScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    filteredData.length,
                        (index) {
                          Dldbtlr product = filteredData[index];
                      return SizedBox(
                        width: 200, // 고정된 너비
                        child: Card(
