...
class SelectZktlxmScreen extends StatefulWidget {
  final List<Zktlxm> data;

  SelectZktlxmScreen({Key? key, required this.data}) : super(key: key);

  @override
  _SelectZktlxmScreenState createState() => _SelectZktlxmScreenState();
}

class _SelectZktlxmScreenState extends State<SelectZktlxmScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    filteredData.length,
                        (index) {
                          Zktlxm product = filteredData[index];
                      return SizedBox(
                        width: 200, // 고정된 너비
                        child: Card(
