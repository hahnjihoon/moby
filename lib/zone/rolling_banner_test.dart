...
class RollingBannerTest extends StatefulWidget {
  @override
  _RollingBannerStateTest createState() => _RollingBannerStateTest();
}

class _RollingBannerStateTest extends State<RollingBannerTest> {
