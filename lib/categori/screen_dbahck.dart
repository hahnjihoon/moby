...
import 'package:moby/zone/dropdown_list.dart';
import 'package:moby/zone/screen_table.dart';
import 'package:moby/zone/web_view_test.dart';
import 'package:moby/html/screen_html_dbahck.dart';

class DbahckScreen extends StatefulWidget {
  const DbahckScreen({super.key});

  @override
  _DbahckScreenState createState() => _DbahckScreenState();
}

class _DbahckScreenState extends State<DbahckScreen> {
  List<Dbahck> products = [
    Dbahck.fromMap({
      'id': 1,
      'majorClass': '출산/유아동',
      'middleClass': '유모차/웨건',
                    ...
                    onPressed: () {
                      ...
                      if (checkedProducts.length < 2) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SelectDbahckScreen(
                    ...
                    onPressed: () {
                      ...
                      if (checkedProducts.length < 2) {
                        ...
                        Navigator.of(context).push(
                            ...
                            MaterialPageRoute(builder: (context) => HtmlDbahckScreen(data: checkedProducts,)));
                      }
                    },
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.white, backgroundColor: Colors.deepPurple,
